 ...
 * $Revision: 4 $
 * $Date: 15/05/06 4:49p $
 * @brief    NUC230_240 Series ADC Driver Header File
 *
 * @note
...
/**
  ...
  * @note NUC230_240 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel

 ...
 * @version  V3.0
 * $Revision: 5 $
 * $Date: 15/08/19 11:10a $
 * @brief    NUC230_240 series I2S driver source file
 *
 * @note
...
/**
  ...
  * @param[in]  i2s The base address of I2S module.
  * @return None
  * @details Clear I2SEN (I2SCON[0]) to disable I2S function.
  */
...
{
    i2s->CON = (i2s->CON & ~(I2S_CON_TXTH_Msk | I2S_CON_RXTH_Msk)) |
               (u32TxThreshold << I2S_CON_TXTH_Pos) |
               (u32RxThreshold << I2S_CON_RXTH_Pos);
}

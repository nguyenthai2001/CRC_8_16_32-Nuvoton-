...
# 333 "../../../../Library/StdDriver/src/retarget.c"
void HardFault_Handler(void)
{
    asm("MOVS    r0, #4                        \n"
        ...
        "MRS     R0, MSP                       \n"
        "B       Hard_Fault_Handler            \n"
        ::[Hard_Fault_Handler] "r" (Hard_Fault_Handler)
    );
    while(1);
}
# 437 "../../../../Library/StdDriver/src/retarget.c"
...
# 517 "../../../../Library/StdDriver/src/retarget.c"
void SendChar(int ch)
{
# 536 "../../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 549 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 573 "../../../../Library/StdDriver/src/retarget.c"
    while(1)
    {
...
# 595 "../../../../Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 14)) == 0);
}
# 610 "../../../../Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FSR & (1ul << 28)) != 0);
}
# 625 "../../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 650 "../../../../Library/StdDriver/src/retarget.c"
...
int _write (int fd, char *ptr, int len)
{
    ...
    while(i--) {
        ...
        ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DATA = *ptr++;
...
int _read (int fd, char *ptr, int len)
{
    ...
    *ptr = ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DATA;
    return 1;

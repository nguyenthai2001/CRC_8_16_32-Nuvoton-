...
int main(void)
{
    ...
    TIMER0->TCSR = TIMER_PERIODIC_MODE | (12 - 1);
    TIMER0->TCMPR = 0xFFFFFF;
    TIMER0->TCSR |= TIMER_TCSR_CEN_Msk;


    /* These sections are for software CRC-32 */
    TIMER0->TCMPR = 0xFFFFFF; // Reload TCMPR to restart Timer0 counting from TDR = 0
    u32CRCResult = crc32_by_table(str, u32StrLen);
    u32CRC32Time = TIMER0->TDR;
